...
<section class="col-md-8">
		<div class="panel panel-success">
  			<div class="panel-heading">Pizzas Cadastradas</div>
...
<section class="col-md-4">
	<div class="panel panel-primary">
  		<div class="panel-heading">Cardápio Pizzas  - Inserir</div>
  		<div class="panel-body">			
        		<?php echo form_open('administracao/pizzas_form'); ?>
