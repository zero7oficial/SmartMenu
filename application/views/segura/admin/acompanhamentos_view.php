...
<section class="col-md-8">
		<div class="panel panel-success">
  			<div class="panel-heading">Acompanhamentos Cadastrados</div>
  			<div class="panel-body">
				...
				<td><a href="<?php echo base_url(); ?>index.php/administracao/excluirAc/<?php echo $row->ID ?>"><button type="button" class="btn btn-danger"><i class="fa fa-trash"></i></button></a> <a href="<?php echo base_url(); ?>index.php/administracao/editarAc/<?php echo $row->ID ?>"><button type="button" class="btn btn-primary"><i class="fa fa-pencil-square-o"></i></button></a></td>
				</tr>
				<?php } ?>		 
  				</table>
...
<section class="col-md-4">
	<div class="panel panel-primary">
  		<div class="panel-heading">ACOMPANHAMENTSO - INSERINDO NO MENU</div>
  		<div class="panel-body">			
        		<?php echo form_open('administracao/acompanhamentos_form'); ?>
				    <label for="titulo">Acompanhamento:</label>
