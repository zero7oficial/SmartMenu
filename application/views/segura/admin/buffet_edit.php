...
<section class="col-md-8">
		<div>
				<p class="text-right"><a href="<?php echo base_url(); ?>index.php/administracao/buffet"><button type="button" class="btn btn-sm btn-warning"><i class="fa fa-plus"></i> <b>Adicionar Novo Buffet</b></button></a></p>
			</div>
		<div class="panel panel-primary">
  			<div class="panel-heading">Buffet  - Editar </div>
  			<div class="panel-body">   				 
				
        		<!-- abre o formulário de edição -->
				<?php echo form_open('administracao/atualizarBu'); ?>
					<input type="hidden" class="form-control" name="ID" value="<?php echo $dados_prato[0]->ID; ?>"/>
					<label for="titulo">Titulo:</label><br/>
					<input type="text" name="titulo" id="titulo" class="form-control" value="<?php echo $dados_prato[0]->titulo; ?>"/>

					<label for="preco">Preço:</label><br/>
					<input type="text" name="preco" id="preco" class="form-control" value="<?php
					$this->load->helper("funcoes");
					$valor = $dados_prato[0]->preco;
					...
					<textarea class="form-control" onkeyup="limitaTextarea(this.value)" id="descricao texto" name="descricao">
						<?php echo $dados_prato[0]->descricao; ?>
					</textarea>
					<br />
				...
				<div class="col-md-4">
					<h4>Enviar Imagem</h4>					
					<img src="<?php echo base_url(); ?>uploads/<?php echo $dados_prato[0]->imagem; ?>.jpg" height="130px" class="responsive">
				</div>
					
				<div class="col-md-8">
					<p>Somente .jpg é permitida. O tamanho máximo é 1024</p>
					<form method="post" action="<?php echo base_url(); ?>index.php/administracao/upimg_Bu" enctype="multipart/form-data" />
	       					<input type="hidden" class="form-control" name="ID" value="<?php echo $dados_prato[0]->ID; ?>"/>
