...
<section class="col-md-8">
		<div>
			<p class="text-right"><a href="<?php echo base_url(); ?>index.php/administracao/cardapio"><button class="btn btn-small btn-warning">Adicionar Novo Produto</button></a></p>
		</div>
		<div class="panel panel-primary">
  			<div class="panel-heading">Cardápio de Lanches  - Editar</div>
  			<div class="panel-body">   				 
				
        	<!-- abre o formulário de edição -->
				<?php echo form_open('administracao/atualizar'); ?>
					<input type="hidden" class="form-control" name="ID" value="<?php echo $dados_pizza[0]->ID; ?>"/>
					<label for="titulo">Titulo:</label><br/>
					<input type="text" name="titulo" id="titulo" class="form-control" value="<?php echo $dados_pizza[0]->titulo; ?>"/>

					<label for="preco">Preço do Produto:</label><br/>
					<input type="text" name="preco" id="preco" class="form-control" value="<?php
					$this->load->helper("funcoes");
					$valor = $dados_pizza[0]->preco;
					echo formata_preco($valor);
					?>"/>
				        <br/>

				    <label for="preco">Estoque do Produto:</label><br/>
					<input type="text" name="qntd" id="preco" class="form-control" value="<?php
					$this->load->helper("funcoes");
					$qntd = $dados_pizza[0]->qntd;
					echo $qntd;
					?>"/>
				        <br/>
					...
					$this->load->helper("funcoes");
					$valorCusto = $dados_pizza[0]->custo;
					echo formata_preco($valorCusto);
					?>"/>
				        <br/>
					...
					<textarea class="form-control" onkeyup="limitaTextarea(this.value)" id="descricao texto" name="descricao">
						<?php echo $dados_pizza[0]->descricao; ?>
					</textarea>
					<br />
			...
			<!-- fecha o formulário de edição -->
				...
				<div class="col-md-4">
					<h4>Enviar Imagem</h4>					
					<img src="<?php echo base_url(); ?>uploads/<?php echo $dados_pizza[0]->imagem; ?>.jpg" height="130px" class="responsive">
				</div>
					
				<div class="col-md-8">
					<p>Somente .jpg é permitida. O tamanho máximo é 1024</p>
					<form method="post" action="<?php echo base_url(); ?>index.php/administracao/upimg_c" enctype="multipart/form-data" />
	       					<input type="hidden" class="form-control" name="ID" value="<?php echo $dados_pizza[0]->ID; ?>"/>
