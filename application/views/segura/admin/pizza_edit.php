...
<section class="col-md-8">
		<div>
			<p class="text-right"><a href="<?php echo base_url(); ?>index.php/administracao/pizzas"><button class="btn btn-small btn-warning">Adicionar Nova Pizza</button></a></p>
		</div>
		<div class="panel panel-primary">
  			<div class="panel-heading">Cardápio de Pizzas  - Editar</div>
  			<div class="panel-body">   				 
				
        		<!-- abre o formulário de edição -->
				<?php echo form_open('administracao/atualizarPiz'); ?>
					...
					?>"/>
				   	...
				   	<label for="preco">Estoque:</label><br/>
				...
				<?php echo form_close(); ?><!-- fecha o formulário de edição -->
				...
				<div class="col-md-8">
					...
					<form method="post" action="<?php echo base_url(); ?>index.php/administracao/upimg_piz" enctype="multipart/form-data" />
	       					<input type="hidden" class="form-control" name="ID" value="<?php echo $dados_pizza[0]->ID; ?>"/>
