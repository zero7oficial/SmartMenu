...
<section class="col-md-8">
		<div>
			<p class="text-right"><a href="<?php echo base_url(); ?>index.php/administracao/caixa"><button class="btn btn-small btn-warning">Adicionar Novo Produto Extra</button></a></p>
		</div>
		<div class="panel panel-primary">
			<div>
				
			</div>
  			<div class="panel-heading"><p><b>EDITANDO PRODUTOS EXTRAS</b></p></div>
  			<div class="panel-body">   				 
				
        		<!-- abre o formulário de edição -->
				<?php echo form_open('administracao/atualizandoProduto'); ?>
